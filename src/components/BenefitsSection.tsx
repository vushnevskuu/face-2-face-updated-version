...
const benefits = [
  {
    icon: Brain,
    title: (<>
      Как остаться востребованным специалистом<br />даже в нестабильных условиях?
    </>),
  ...
  },
  {
    icon: TrendingUp,
    title: (<>
      Почему важно активно искать<br />новые перспективы?
    </>),
  ...
  },
  {
    icon: Package,
    title: (<>
      Какие продукты можно создать<br />на основе накопленного опыта?
    </>),
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              <div key={index} className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 md:p-8 hover:shadow-xl transition-shadow duration-300 relative overflow-hidden">
                ...
                <h3 className="text-lg md:text-[18px] font-bold text-black dark:text-white mb-3 md:mb-4">
                  {benefit.title}
                </h3>
