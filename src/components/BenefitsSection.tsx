...
const benefits = [
  {
    ...
    description: "Какие инструменты использовать <br />для совершенствования коммуникаций <br />с клиентами и партнерами",
    color: "blue"
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    items: [
      <>Что реально движет клиентом<br />при выборе продавца?</>,
      "Как установить доверительный контакт с клиентом?",
      "3 ключевых триггера покупок",
    ],
    color: "blue"
  }
];
